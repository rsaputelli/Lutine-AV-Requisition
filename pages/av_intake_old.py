...
st.set_page_config(page_title="AV Intake", layout="wide")
...
with left:
    ...
    client_name = st.text_input("Client (optional)", value=client_name_default or "")
    meeting_manager_name = st.text_input("Meeting Manager Name (optional)", value=mm_name_default or "")
    meeting_manager_email = st.text_input("Meeting Manager Email (optional)", value=mm_email_default or "")
...
with right:
    ...
    if st.button("Submit AV Request", disabled=submit_disabled, type="primary"):
        try:
            # IMPORTANT:
            # event_id is nullable in your locked design, but your current schema has event_id NOT NULL.
            # This code assumes you have altered event_id to be nullable.
            #
            # venue_id is required in your locked design, but your current schema doesn't have it yet.
            # This code assumes you added venue_id + FK.
            ...
            av_request_payload = {
                ...
                # New required field per your workflow:
